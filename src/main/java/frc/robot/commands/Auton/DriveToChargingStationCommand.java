...
public class DriveToChargingStationCommand extends CommandBase {
    ...
    public void initialize() {
        ...
        Trajectory trajectory = TrajectoryGenerator.generateTrajectory(new Pose2d(0, 0, new Rotation2d(0)), List.of(new Translation2d(-1, 0)), new Pose2d(-3, 0, new Rotation2d(0)), trajectoryConfig);
